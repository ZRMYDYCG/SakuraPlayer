...
<template>
  <div class="code_wrapper">
    <div class="split_code">
      <ul>
        <li v-for="(item, index) in len" :key="index">
          {{ splitNum[index] ? splitNum[index] : '' }}
        </li>
      </ul>
    </div>
    <van-field v-model="codeVal" class="input" type="number" autofocus :maxlength="len" placeholder="验证码" />
