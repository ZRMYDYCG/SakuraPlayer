import type { EmaiLoginParams, PhoneLoginParams } from '@/types/api/user'
import { defineStore } from 'pinia'
import { reqGetUserInfo, reqLikeList, reqLoginByEmail, reqLoginByPhone, reqLogout } from '@/api/modules/user'
