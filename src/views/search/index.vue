...
import { ref } from 'vue'
import { reqHotSearch, reqSearchDefault, reqSearchSuggest } from '@/api/modules/search'
    ...
    <div class="search">
        ...
        <div class="top_search">
          ...
          <div class="center">
            <div class="search_wrapper">
              <input v-model="keyWord" type="text" :placeholder="defaultPlaceholder" @input="onFocus">
              <div v-show="showClose" class="close flex_box_center_column" @click="clearKeyWord">
                <van-icon name="cross" size="14px" />
              </div>
            </div>
          </div>
          <div class="right flex_box_center_column" @click="handleSearch">
            搜索
          </div>
        </div>
      </van-sticky>
      <div v-if="showSuggest" class="showSuggest">
        ...
        <van-empty v-if="suggestList.length == 0 && !suggestLoading" description="没有结果" />
      </div>
      ...
      <div v-if="showDefault">
        ...
        <div class="hot_search">
          ...
          <div v-for="(item, index) in hotList" :key="index" class="hot_item" @click="tapHot(item.first)">
            {{ item.first }}
          </div>
        </div>
      </div>
